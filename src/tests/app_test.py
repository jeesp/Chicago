...
class TestPlayer(unittest.TestCase):
    ...
    def test_end_trick_succesful_blanco(self):
        ...
        end_trick(chicago_on, chicago_successful, chicago_player, blanco_is_on, compare_card, self.score_board)
        self.assertEqual((self.score_board[self.player3], self.score_board[self.player2]), (30, 0))
    def test_end_trick_unsuccesful_chicago(self):
        ...
        end_trick(chicago_on, chicago_successful, chicago_player, blanco_is_on, compare_card, self.score_board)
        self.assertEqual((self.score_board[self.player3], self.score_board[self.player2]), (-15, 5))
    def test_end_trick_unsuccesful_blanco(self):
        ...
        compare_card = (5, 'spades', self.player2)
        end_trick(chicago_on, chicago_successful, chicago_player, blanco_is_on, compare_card, self.score_board)
        self.assertEqual((self.score_board[self.player3], self.score_board[self.player2]), (-30, 5))
    def test_end_trick_no_chicago(self):
        ...
        compare_card = (5, 'spades', self.player2)
        end_trick(chicago_on, chicago_successful, chicago_player, blanco_is_on, compare_card, self.score_board)
        self.assertEqual((self.score_board[self.player3], self.score_board[self.player2]), (0, 5))
