        ...
        while deals < 2:
            ...
            if value_comparison[0] != 0:
                ...
                if value_comparison[2] == 0:
                    print("Pisteet sai: " +value_comparison[0].name + ". Käsi: " + hand_values[value_comparison[1]].lower() + ".")
                if value_comparison[2] == 1:
                    print("Pisteet sai: " +value_comparison[0].name + ". Käsi: " + hand_values[value_comparison[1]].lower() + ". Myös toisella pelaajalla oli " + hand_values[value_comparison[1]].lower() + ".")
            else:
                if value_comparison[2] == 2:
                    print("Kahdella pelaajalla on sama käsi: " + hand_values[value_comparison[1]].lower() + ". Kukaan ei saanut pisteitä.")
                else:
